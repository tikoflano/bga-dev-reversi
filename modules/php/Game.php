 ...
 * tutorialreversitikoflano implementation : © <Your name here> <Your email address here>
 *
...
namespace Bga\Games\tutorialreversitikoflano;
...
class Game extends \Table {
    ...
    protected function getAllDatas(): array {
        ...
        // TODO: Gather all information about current game situation (visible by p  layer $current_player_id).
    ...
    protected function setupNewGame($players, $options = []) {
        ...
        $sql_values = [];
        [$blackplayer_id, $whiteplayer_id] = array_keys($players);
        for ($x = 1; $x <= 8; $x++) {
            for ($y = 1; $y <= 8; $y++) {
                $token_value = "NULL";
                if (($x == 4 && $y == 4) || ($x == 5 && $y == 5)) {
            ...
            foreach ($directions as list($d0, $d1)) {
                ...
                while ($bContinue) {
                    ...
                    elseif ($board[$current_x][$current_y] != $player) {
                        ...
                        $mayBeTurnedOver[] = ["x" => $current_x, "y" => $current_y];
                    } elseif ($board[$current_x][$current_y] == $player) {
